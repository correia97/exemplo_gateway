...
## Key Decisions
- All images are official (postgres:17, quay.io/keycloak/keycloak:latest, quay.io/coreos/etcd:v3.5, apache/Kong:3.9.1-alpine)
- Kong entrypoint follows start→init→foreground pattern for proper PID 1 handling
