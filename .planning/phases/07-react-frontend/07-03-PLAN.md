...
|-----------|----------|-----------|-------------|-----------------|
| T-07-10 | Spoofing | Music write operations | mitigate | apiFetch injects Bearer token; Kong validates JWT + scope for all POST/PUT/DELETE |
...
| T-07-13 | Elevation of Privilege | Write scope check | mitigate | Frontend conditionally hides buttons based on isAuthenticated, but true enforcement is at Kong level |
</threat_model>
