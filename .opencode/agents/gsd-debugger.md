...
<required_reading>
@D:/projetos/opencodeDeepseek/.opencode/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@D:/projetos/opencodeDeepseek/.opencode/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = D:/projetos/opencodeDeepseek/.opencode
                  → checks D:/projetos/opencodeDeepseek/.opencode/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = D:/projetos/opencodeDeepseek/.opencode/get-shit-done
                  → writes to D:/projetos/opencodeDeepseek/.opencode/get-shit-done/hooks/
...
@D:/projetos/opencodeDeepseek/.opencode/get-shit-done/references/thinking-models-debug.md
...
- Read @D:/projetos/opencodeDeepseek/.opencode/get-shit-done/references/common-bug-patterns.md
