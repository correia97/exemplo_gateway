...
Reference full template: `D:/projetos/opencodeDeepseek/.opencode/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/projetos/opencodeDeepseek/.opencode/get-shit-done/templates/state.md`.
