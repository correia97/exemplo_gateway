...
<template>
@D:/projetos/opencodeDeepseek/.opencode/get-shit-done/templates/UAT.md
</template>
...
Read and follow `D:/projetos/opencodeDeepseek/.opencode/get-shit-done/workflows/transition.md`.
...
```bash
node "D:/projetos/opencodeDeepseek/.opencode/get-shit-done/bin/gsd-tools.cjs" audit-open --json 2>/dev/null
```
...
- Follow @D:/projetos/opencodeDeepseek/.opencode/get-shit-done/workflows/diagnose-issues.md
