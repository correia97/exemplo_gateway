...
<required_reading>
@D:/projetos/opencodeDeepseek/.opencode/get-shit-done/references/ai-frameworks.md
@D:/projetos/opencodeDeepseek/.opencode/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read D:/projetos/opencodeDeepseek/.opencode/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "D:/projetos/opencodeDeepseek/.opencode/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read D:/projetos/opencodeDeepseek/.opencode/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read D:/projetos/opencodeDeepseek/.opencode/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read D:/projetos/opencodeDeepseek/.opencode/agents/gsd-eval-planner.md for instructions.
