...
```
Task(
  prompt="Read D:/projetos/opencodeDeepseek/.opencode/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/projetos/opencodeDeepseek/.opencode/get-shit-done/templates/SECURITY.md`
