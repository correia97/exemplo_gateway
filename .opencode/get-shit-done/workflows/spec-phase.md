...
```bash
INIT=$(node "D:/projetos/opencodeDeepseek/.opencode/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @D:/projetos/opencodeDeepseek/.opencode/get-shit-done/templates/spec.md.
