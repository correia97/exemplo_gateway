...
Key references:
- @D:/projetos/opencodeDeepseek/.opencode/get-shit-done/references/ui-brand.md (display patterns)
- @D:/projetos/opencodeDeepseek/.opencode/get-shit-done/agents/gsd-user-profiler.md (profiler agent definition)
- @D:/projetos/opencodeDeepseek/.opencode/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="D:/projetos/opencodeDeepseek/.opencode/get-shit-done/USER-PROFILE.md"
...
```bash
cp "D:/projetos/opencodeDeepseek/.opencode/get-shit-done/USER-PROFILE.md" "D:/projetos/opencodeDeepseek/.opencode/USER-PROFILE.backup.md"
```
...
✓ Stores profile at D:/projetos/opencodeDeepseek/.opencode/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `D:/projetos/opencodeDeepseek/.opencode/get-shit-done/references/user-profiling.md`
...
Reference: @D:/projetos/opencodeDeepseek/.opencode/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to D:/projetos/opencodeDeepseek/.opencode/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global AGENTS.md" -- "Add profile to D:/projetos/opencodeDeepseek/.opencode/AGENTS.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at D:/projetos/opencodeDeepseek/.opencode/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at D:/projetos/opencodeDeepseek/.opencode/commands/gsd/dev-preferences.md"
...
Display: "✓ Added profile section to D:/projetos/opencodeDeepseek/.opencode/AGENTS.md"
...
```bash
BACKUP_PATH="D:/projetos/opencodeDeepseek/.opencode/USER-PROFILE.backup.md"
```
...
Your profile:    D:/projetos/opencodeDeepseek/.opencode/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   D:/projetos/opencodeDeepseek/.opencode/commands/gsd/dev-preferences.md
  ✓ AGENTS.md section       ./AGENTS.md
  ✓ Global AGENTS.md        D:/projetos/opencodeDeepseek/.opencode/AGENTS.md
```
