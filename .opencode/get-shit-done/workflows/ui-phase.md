...
```markdown
Read D:/projetos/opencodeDeepseek/.opencode/agents/gsd-ui-researcher.md for instructions.
...
Template: D:/projetos/opencodeDeepseek/.opencode/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read D:/projetos/opencodeDeepseek/.opencode/agents/gsd-ui-checker.md for instructions.
