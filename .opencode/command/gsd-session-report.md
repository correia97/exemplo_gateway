...
<execution_context>
@D:/projetos/opencodeDeepseek/.opencode/get-shit-done/workflows/session-report.md
</execution_context>

<process>
Execute the session-report workflow from @D:/projetos/opencodeDeepseek/.opencode/get-shit-done/workflows/session-report.md end-to-end.
</process>
