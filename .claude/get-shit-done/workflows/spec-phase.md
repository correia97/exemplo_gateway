...
```bash
INIT=$(node "D:/projetos/opencodeDeepseek/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @D:/projetos/opencodeDeepseek/.claude/get-shit-done/templates/spec.md.
