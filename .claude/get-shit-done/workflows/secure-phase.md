...
```
Task(
  prompt="Read D:/projetos/opencodeDeepseek/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/projetos/opencodeDeepseek/.claude/get-shit-done/templates/SECURITY.md`
