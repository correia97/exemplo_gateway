...
```markdown
Read D:/projetos/opencodeDeepseek/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: D:/projetos/opencodeDeepseek/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read D:/projetos/opencodeDeepseek/.claude/agents/gsd-ui-checker.md for instructions.
