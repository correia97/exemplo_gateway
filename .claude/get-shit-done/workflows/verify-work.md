...
Read and follow `D:/projetos/opencodeDeepseek/.claude/get-shit-done/workflows/transition.md`.
...
- Follow @D:/projetos/opencodeDeepseek/.claude/get-shit-done/workflows/diagnose-issues.md
