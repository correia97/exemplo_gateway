...
```bash
INIT=$(node "D:/projetos/opencodeDeepseek/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "D:/projetos/opencodeDeepseek/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
