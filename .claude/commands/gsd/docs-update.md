...
<execution_context>
@D:/projetos/opencodeDeepseek/.claude/get-shit-done/workflows/docs-update.md
</execution_context>
...
<process>
Execute the docs-update workflow from @D:/projetos/opencodeDeepseek/.claude/get-shit-done/workflows/docs-update.md end-to-end.
